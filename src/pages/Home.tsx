    ...
    <section className="stack gap-xl">
      <section className="hero">
        <div className="hero-copy">
          <h1>
            Hi, I’m <span className="accent">Barecha Ashenafi</span> 👋
          </h1>
          <p className="lead">
      ...
      <section>
        ...
        <div className="grid">
          {featured.map((p) => (
            <a key={p.id} href={`/projects#${p.id}`} className="card-link">
      ...
      <section className="cta">
        ...
        <p>
          Need a React expert on your team? I can help with design systems,
          performance, and DX.
        </p>
